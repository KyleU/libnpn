...
// source: github.com/kyleu/npn/libnpn/npntemplate/html/connection/detail.html
// DO NOT EDIT!
package npntemplate
...
<div class="uk-section uk-section-small">
  <div class="uk-container">
	...
	hero.EscapeHTML(npncore.KeyChannel, _buffer)
	_buffer.WriteString(`">Channel</label>
            <input class="uk-input" name="`)
	hero.EscapeHTML(npncore.KeyChannel, _buffer)
	_buffer.WriteString(`" type="text" value="`)
	hero.EscapeHTML(msg.Channel, _buffer)
	_buffer.WriteString(`" />
          </div>
